...
print(" this sentence follow above")
...
var w = [1, 1.2]
//求变量类型
let wMirror = Mirror(reflecting: w)
print(wMirror.subjectType)
...
//求变量类型
let convertedNumberMirror = Mirror(reflecting: convertedNumber as Any )
print(convertedNumberMirror.subjectType)
